	...
	return func(c *gin.Context) {
		defer func() {
			if r := recover(); r != nil {
				...
				c.AbortWithStatusJSON(500, common.NewInternalSeverErrorResponse(errors.New("internal Server Error"), "Something went wrong with server", utils.ToString(debug.Stack())))
			}
		}()
